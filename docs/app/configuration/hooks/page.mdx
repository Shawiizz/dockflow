...
Hooks are enabled by default. Configure in `.dockflow/config.yml`:
...
<Callout type="warning">
  If a hook fails, the deployment is aborted. Make sure your hook scripts are tested and handle errors gracefully.
</Callout>
