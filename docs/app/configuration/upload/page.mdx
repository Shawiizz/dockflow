...
- [Hooks](/configuration/hooks) — use `pre-deploy` to reload services after upload (e.g. `systemctl daemon-reload`)
- [Templates](/configuration/templates) — full reference for available template variables
