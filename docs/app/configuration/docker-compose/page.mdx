...
- **`servers.yml`** — defined per-environment or per-server (see [Servers & Connections](/configuration/servers))
...
**Next:** [Build Strategy](/configuration/build-strategy) — choose how to build and transfer Docker images.
