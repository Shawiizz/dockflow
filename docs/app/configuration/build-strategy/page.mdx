...
This is the simplest strategy and works for both single-node deployments and multi-node clusters. For larger clusters with many nodes or heavy images, consider using a [registry](/configuration/registry) instead.
...
**Next:** [Deployment](/deployment) — understand what happens when you deploy.
