...
export default function Page() {
  return (
    <div className="fixed inset-0 z-[9999] overflow-y-auto font-sans text-neutral-50 bg-neutral-950">
      {/* ── Navbar ── */}
      <nav className="sticky top-0 z-50 flex items-center justify-between px-6 py-3 bg-neutral-950/80 backdrop-blur-md border-b border-neutral-800">
        <div className="flex items-center gap-2.5">
          <img src="/logo.svg" alt="Dockflow" className="h-[22px]" />
          <span className="font-bold text-base">Dockflow</span>
        </div>
        <div className="flex items-center gap-5">
          <Link href="/getting-started" className="text-neutral-400 text-sm no-underline">Docs</Link>
          <a href="https://github.com/Shawiizz/dockflow" target="_blank" rel="noreferrer" className="text-neutral-400 text-sm no-underline">
            GitHub
          </a>
          <Link href="/getting-started" className="inline-flex items-center gap-1.5 px-4 py-[7px] rounded-lg bg-neutral-50 text-neutral-950 text-[13px] font-semibold no-underline">
            Get Started
          </Link>
        </div>
      </nav>
      ...
      {/* ── Hero ── */}
      <section className="relative overflow-hidden min-h-[calc(100vh-49px)] flex items-center">
        <div className="absolute inset-0 z-0 opacity-60 pointer-events-none">
          <HeroBackground />
        </div>
        <div className="relative z-[1] max-w-[900px] mx-auto px-6 py-15 text-center w-full">
          ...
          <h1 className="text-[clamp(2.5rem,6vw,4.5rem)] font-extrabold leading-[1.05] m-0 tracking-tight">
            Ship to production
            <br />
            <span className="bg-gradient-to-br from-red-500 to-orange-400 bg-clip-text text-transparent">without Kubernetes.</span>
          </h1>
          ...
          <div className="flex justify-center gap-3 mt-8 flex-wrap">
            <Link href="/getting-started" className="inline-flex items-center gap-2 px-7 py-3 rounded-[10px] bg-neutral-50 text-neutral-950 text-[15px] font-semibold no-underline">
              Get Started
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14" /><path d="m12 5 7 7-7 7" /></svg>
            </Link>
            <a href="https://github.com/Shawiizz/dockflow" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 px-7 py-3 rounded-[10px] border border-neutral-800 text-neutral-50 text-[15px] font-medium no-underline bg-neutral-900/50">
      ...
      {/* ── Terminal showcase ── */}
      <section className="max-w-[1100px] mx-auto px-6 pb-14 grid grid-cols-2 gap-10 items-center">
        <Terminal />
        <div>
          <h2 className="text-[28px] font-bold m-0 leading-tight">
            Scaffolded. Configured.
            <br />
            <span className="bg-gradient-to-br from-red-500 to-orange-400 bg-clip-text text-transparent">Deployed.</span>
          </h2>
          ...
          <div className="mt-6 rounded-[10px] overflow-hidden bg-gradient-to-br from-red-500 to-orange-400 p-px">
            <div className="bg-neutral-950 rounded-[9px] px-5 py-4 font-mono text-[13px] leading-8">
              ...
              <div><span className="bg-gradient-to-br from-red-500 to-orange-400 bg-clip-text text-transparent">$</span> <span className="text-neutral-50">dockflow init</span></div>
              ...
              <div><span className="bg-gradient-to-br from-red-500 to-orange-400 bg-clip-text text-transparent">$</span> <span className="text-neutral-50">dockflow setup</span></div>
              <div><span className="text-neutral-500"># ship it</span></div>
              <div><span className="bg-gradient-to-br from-red-500 to-orange-400 bg-clip-text text-transparent">$</span> <span className="text-neutral-50">dockflow deploy production</span></div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* ── Before / After ── */}
      <section className="max-w-[800px] mx-auto px-6 pt-14 pb-20">
        ...
        <div className="grid grid-cols-2 gap-5">
          {/* Without */}
          <div className="rounded-xl p-7 border border-neutral-800 bg-[var(--color-card)]">
          ...
          {/* With */}
          <div className="rounded-xl p-7 border border-orange-500/25 bg-[var(--color-card)] shadow-[0_0_40px_rgba(239,68,68,.04)]">
            <div className="text-[11px] font-bold uppercase tracking-widest mb-5 bg-gradient-to-br from-red-500 to-orange-400 bg-clip-text text-transparent">
              With Dockflow
            </div>
            {[
              ...
              <div key={cmd} className="flex items-start gap-2.5 mb-3">
                ...
                <span className="text-sm leading-normal">
                  <code className="text-orange-400 font-mono text-[13px] bg-transparent p-0 border-none">{cmd}</code>
      ...
      {/* ── Features bento ── */}
      <section className="max-w-[1000px] mx-auto px-6 pt-4 pb-20">
        <h2 className="text-[32px] font-bold text-center m-0">
          Everything you need
        </h2>
        <p className="text-neutral-400 text-center text-[15px] mt-3 mb-12">
      ...
      <section className="text-center px-6 py-20 border-t border-neutral-800">
        ...
        <Link href="/getting-started" className="inline-flex items-center gap-2 mt-7 px-7 py-3 rounded-[10px] bg-neutral-50 text-neutral-950 text-[15px] font-semibold no-underline">
          Get Started
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14" /><path d="m12 5 7 7-7 7" /></svg>
        </Link>
      </section>
      ...
      {/* ── Footer ── */}
      <footer className="text-center p-6 text-xs text-neutral-500 border-t border-neutral-800">
        Dockflow — Deploy with confidence.
      </footer>
    </div>
  )
}
...
function FeatureCard({ icon, title, desc, large }: { icon: React.ReactNode; title: string; desc: string; large?: boolean }) {
  return (
    <div className={`rounded-xl border border-neutral-800 bg-[var(--color-card)] ${large ? "p-7" : "p-5"}`}>
