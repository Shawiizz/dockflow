...
const sequence: Line[] = [
  ...
  { text: "  Dockflow v1.0.0 — Deploy with confidence", color: "text-neutral-500" },
  { text: "\u00A0", color: "text-transparent" },
  { text: "  ▸ Loading config...", color: "text-neutral-500" },
  { text: "  ✓ Config valid (2 servers, 1 manager)", color: "text-green-400" },
  { text: "\u00A0", color: "text-transparent" },
  { text: "  ▸ Connecting to production manager...", color: "text-neutral-500" },
  { text: "  ✓ SSH connected to 10.0.1.50", color: "text-green-400" },
  { text: "\u00A0", color: "text-transparent" },
  { text: "  ▸ Building image...", color: "text-neutral-500" },
  { text: "  [██████████████████████████████] 100%", color: "text-blue-400" },
  { text: "  ✓ Image built: myapp-production:1.4.0", color: "text-green-400" },
  { text: "\u00A0", color: "text-transparent" },
  { text: "  ▸ Transferring image via SSH...", color: "text-neutral-500" },
  { text: "  ✓ Image loaded on manager", color: "text-green-400" },
  { text: "  ✓ Image distributed to worker-01", color: "text-green-400" },
  { text: "\u00A0", color: "text-transparent" },
  { text: "  ▸ Deploying stack...", color: "text-neutral-500" },
  { text: "  → Updating service myapp_app", color: "text-neutral-400" },
  { text: "  → Rolling update: 1/2 → 2/2", color: "text-neutral-400" },
  { text: "  ✓ Stack deployed", color: "text-green-400" },
  { text: "\u00A0", color: "text-transparent" },
  { text: "  ▸ Running health checks...", color: "text-neutral-500" },
  { text: "  ✓ All containers healthy", color: "text-green-400" },
  { text: "\u00A0", color: "text-transparent" },
  { text: "  ✓ Deployed v1.4.0 to production in 18.7s", color: "text-green-400", bold: true },
]
